...
class FeatureEngineering:
    ...
    def create_labels_sltp_aware(self, df):
        ...
        """
        print(f"🏷️ Creating SL/TP-aware labels (TP={self.profit_threshold:.2%}, SL={self.stop_loss_threshold:.2%})...")
    ...
    def create_labels(self, df):
        ...
        if self.labeling_method == 'sltp_aware':
            ...
            print("🏷️ Creating labels (future_return method)...")
            print("⚠️ WARNING: This method doesn't account for SL/TP and may not reflect real profitability!")
